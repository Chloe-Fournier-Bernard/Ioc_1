...
var slider = {
  ...
  stimulus: function() {
    ...
    if (response == "Patients are more likely to recover after receiving the medicine") {
      ...
      "To be more specific, to what extent do you think people are more likely to get better with the medicine (instead of the placebo)?";
    } else {
      questionText = "Erreur : réponse inattendue." + response;
    }
    //slider mesure Matute
    if (typeof response === 'undefined') questionText = "To what extent do you think that the medicine has been effective in healing the crises of the patients you have seen?";
